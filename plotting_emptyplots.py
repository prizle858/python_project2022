...
# gryffindor = [[],[],[],[],[]] # 2D list of traits in Gryffindor
# hufflepuff = [[],[],[],[],[]] # 2D list of traits in Hufflepuff
# ravenclaw = [[],[],[],[],[]]  # 2D list of traits in Ravenclaw
# slytherin = [[],[],[],[],[]] # 2D list of traits in Slytherin
...
def func(house, num_row_df):
    ...
    if house == 'Gryffindor':
        ...
        templist_h.append(num_row_df) # e.g. num_row_df = number of i = 'Hufflepuff, j = 'Female'
        #hufflepuff.append(templist_h)
    elif house == 'Ravenclaw':
        templist_r.append(num_row_df) # e.g. num_row_df = number of i = 'Ravenclaw, j = 'Female'
        #ravenclaw.append(templist_r)
    elif house == 'Slytherin':
        templist_s.append(num_row_df) # e.g. num_row_df = number of i = 'Slytherin, j = 'Female'
        #slytherin.append(templist_s)

def func2():
    gryffindor.append(list(templist_g))
    hufflepuff.append(list(templist_h))
    ravenclaw.append(list(templist_r))
    slytherin.append(list(templist_s))
    # print(gryffindor)
